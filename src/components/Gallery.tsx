...
export default function Gallery() {
  return (
    <section id="gallery" className="section-pad bg-soft" aria-labelledby="gallery-heading">
      <div className="container-premium">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-sm text-muted md:text-base">
            Moments from our pandal, Rath Yatra, and community festivals —
            curated from our Facebook page.
          </p>
        </div>
          ...
          {gallery.map((item) => (
            <li key={item.file}>
              <figure className="group relative aspect-[4/3] overflow-hidden rounded-sm border border-parchment bg-navy/5">
                ...
                />
                <figcaption className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-navy/90 via-navy/55 to-transparent px-4 pb-3.5 pt-10">

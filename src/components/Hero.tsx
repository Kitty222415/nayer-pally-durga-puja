    ...
    >
      ...
      <div className="container-premium relative z-10 section-pad pt-20 md:pt-32">
        <div className="mx-auto max-w-3xl text-center fade-up">
          <div className="mx-auto mb-3 flex h-24 w-24 items-center justify-center rounded-full border-2 border-cream/75 bg-navy/35 p-2 shadow-[0_0_24px_rgba(228,199,101,0.5)] backdrop-blur-sm md:hidden">
            <Image
